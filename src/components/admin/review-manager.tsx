...
export default function ReviewManager({
  ...
  return (
    <div className="mt-6 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
      <form onSubmit={createOrUpdateReview} className="rounded-3xl border border-[#1b3c53]/10 bg-white p-5 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-bold text-[#1b3c53]">{editingReviewId ? 'Update Review' : 'Create Review'}</h3>
