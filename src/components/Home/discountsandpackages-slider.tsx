            ...
            <SwiperSlide key={card.id} className="h-auto">
              ...
              >
                ...
                <div className="relative flex h-full flex-col items-start justify-between">
                  ...
                  <span className="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold uppercase tracking-[0.08em] text-[#1B3C53] transition duration-300 group-hover:bg-[#EAF2F7]">
                    View Details
