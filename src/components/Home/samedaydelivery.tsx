        ...
        <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="font-serif text-3xl font-bold leading-tight text-stone-900 sm:text-4xl lg:text-5xl">
              Same Day Delivery in London & Across the UK
            </h2>

            <p className="mt-2 text-base text-stone-600">
              24-hour delivery for urgent print orders, with fast dispatch across
          ...
          <div className="flex items-center gap-3">
            <button
              aria-label="Previous"
              className="arrivals-prev flex h-12 w-12 items-center justify-center rounded-full border border-stone-300 bg-white text-stone-900 transition-all duration-300 hover:bg-stone-900 hover:text-white"
            >
            ...
            <button
              aria-label="Next"
              className="arrivals-next flex h-12 w-12 items-center justify-center rounded-full border border-stone-300 bg-white text-stone-900 transition-all duration-300 hover:bg-stone-900 hover:text-white"
            >
