...
export const metadata: Metadata = {
  title: 'Customer Reviews | Prime Print',
  description:
    'Read what our customers say about Prime Print printing services, quality, delivery, and customer support.',
  alternates: {
    canonical: '/reviews',
  },
  openGraph: {
    title: 'Customer Reviews | Prime Print',
    description:
      'Discover customer testimonials and ratings for Prime Print printing services.',
    url: '/reviews',
    type: 'website',
      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-stone-600">
            Read what our customers say about Prime Print printing quality, delivery, and service.
          </p>
          {reviews.length > 0 && (
        ...
        <div className="mt-16 rounded-2xl border border-stone-200 bg-white p-8 text-center md:p-10">
          ...
          <p className="mt-3 text-sm text-stone-600">
            Have you used Prime Print? We&apos;d love to hear about your experience.
          </p>
          <Link
            href="/contact"
